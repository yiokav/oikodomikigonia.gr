    ...
    <div class="w-100 overflow-hidden bg-gray-100" id="top">
      ...
      <div class="container position-relative">
        <div class="col-12 col-lg-8 mt-0 h-100 position-absolute top-0 end-0 bg-cover" data-aos="fade-left"
          style="background-image: url('<?php echo e(asset('img/buddy-an.jpg')); ?>');">
      ...
      <div class="container">
        ...
        <div class="row d-flex align-items-center">
          <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <span class="h5 fw-lighter">ASE Makine</span>
            <h3 class="py-5 border-top border-dark">Αποκλειστικός συνεργάτης ASE Makine</h3>
            ...
            <a href="<?php echo e(route('ase.index')); ?>" class="link-fancy">Περισσότερα
            </a>
          </div>
            ...
            <div class="row gx-5 d-flex">
              <div class="col-md-11">
                <div class="shadow ratio ratio-16x9 rounded bg-cover bp-center align-self-end" data-aos="fade-right"
                  style="background-image: url('<?php echo e(asset('img/paints.jpeg')); ?>');--bs-aspect-ratio: 50%;">
                </div>
              </div>
              <div class="col-md-5 offset-md-1">
                <div class="shadow ratio ratio-1x1 rounded bg-cover mt-5 bp-center float-end" data-aos="fade-up"
                  style="background-image: url('<?php echo e(asset('img/tools.jpg')); ?>');">
                </div>
              </div>
              <div class="col-md-6">
                <div class="col-12 shadow ratio rounded bg-cover mt-5 bp-center" data-aos="fade-left"
                  style="background-image: url('<?php echo e(asset('img/store.jpeg')); ?>');--bs-aspect-ratio: 150%;">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-12">
            <div class="row vw-100 px-0 py-vh-2 d-flex align-items-center scrollx">
              <div class="col-md-3" data-aos="fade-up">
                <img src="<?php echo e(asset('img/img1.jpg')); ?>" class="img-fluid rounded shadow" alt="nice gallery image">
              </div>

              <div class="col-md-3" data-aos="fade-up" data-aos-delay="200">
                <img src="<?php echo e(asset('img/img2.jpg')); ?>" class="img-fluid rounded shadow" alt="nice gallery image">
              </div>

              <div class="col-md-3" data-aos="fade-up" data-aos-delay="400">
                <img src="<?php echo e(asset('img/img3.jpg')); ?>" class="img-fluid rounded shadow" alt="nice gallery image">
              </div>
            </div>
            <div class="row vw-100 px-0 py-vh-2 d-flex align-items-center scrollx">
              <div class="col-md-3" data-aos="fade-up">
                <img src="<?php echo e(asset('img/img4.jpg')); ?>" class="img-fluid rounded shadow" alt="nice gallery image">
              </div>

              <div class="col-md-3" data-aos="fade-up" data-aos-delay="200">
                <img src="<?php echo e(asset('img/img5.jpg')); ?>" class="rounded shadow img-fluid" alt="nice gallery image">
              </div>

              <div class="col-md-3" data-aos="fade-up" data-aos-delay="400">
                <img src="<?php echo e(asset('img/img6.jpg')); ?>" class="rounded shadow img-fluid" alt="nice gallery image">
              </div>
            </div>
            <div class="row vw-100 px-0 py-vh-2 d-flex align-items-center scrollx">

              <div class="col-md-3" data-aos="fade-up">
                <img src="<?php echo e(asset('img/img7.jpg')); ?>" class="rounded shadow img-fluid" alt="nice gallery image">
              </div>

              <div class="col-md-3" data-aos="fade-up" data-aos-delay="200">
                <img src="<?php echo e(asset('img/img8.jpg')); ?>" class="rounded shadow img-fluid" alt="nice gallery image">
              </div>

              <div class="col-md-3" data-aos="fade-up" data-aos-delay="400">
                <img src="<?php echo e(asset('img/img9.jpg')); ?>" class="rounded shadow img-fluid" alt="nice gallery image">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row d-flex justify-content-center">
          <div class="col-lg-8" data-aos="fade">
            ...
            <form action="<?php echo e(route('contact.store')); ?>" method="POST" class="text-start">
              <?php echo csrf_field(); ?>
              <div class="mb-3">
                ...
                <input type="text" name="name" id="contact-name" class="form-control form-control-lg bg-dark text-light border-secondary"
                  value="<?php echo e(old('name')); ?>" required maxlength="255" placeholder="Το όνομά σας">
              </div>
              <div class="mb-3">
                ...
                <input type="email" name="email" id="contact-email" class="form-control form-control-lg bg-dark text-light border-secondary"
                  value="<?php echo e(old('email')); ?>" required placeholder="example@email.com">
              </div>
              <div class="mb-3">
                ...
                <input type="text" name="subject" id="contact-subject" class="form-control form-control-lg bg-dark text-light border-secondary"
                  value="<?php echo e(old('subject')); ?>" required maxlength="255" placeholder="Θέμα μηνύματος">
              </div>
              <div class="mb-4">
                ...
                <textarea name="message" id="contact-message" class="form-control form-control-lg bg-dark text-light border-secondary" rows="5"
                  required maxlength="10000" placeholder="Γράψτε το μήνυμά σας..."><?php echo e(old('message')); ?></textarea>
              </div>
                ...
                <div class="card p-4 shadow mt-3 border-0" data-aos="fade-down">
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between border-top pt-3">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" width="48" height="48" class="rounded-circle" viewBox="0 0 24 24" id="user-9" data-name="Line Color" class="icon line-color"><path id="secondary" d="M7.46,13.26A5,5,0,0,0,4,18v1s2,2,8,2,8-2,8-2V18a5,5,0,0,0-3.51-4.75" style="fill: none; stroke: rgb(44, 169, 188); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"/><circle id="primary" cx="12" cy="9" r="6" style="fill: none; stroke: rgb(0, 0, 0); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"/></svg>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card p-4 mt-3 border-0">
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between border-top pt-3">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" width="48" height="48" viewBox="0 0 24 24" id="user-9" data-name="Line Color" class="icon line-color"><path id="secondary" d="M7.46,13.26A5,5,0,0,0,4,18v1s2,2,8,2,8-2,8-2V18a5,5,0,0,0-3.51-4.75" style="fill: none; stroke: rgb(44, 169, 188); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"/><circle id="primary" cx="12" cy="9" r="6" style="fill: none; stroke: rgb(0, 0, 0); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"/></svg>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="row">
          <div class="col-md-12 col-lg-3 border-end" data-aos="fade-up">
            <div class="d-flex">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" width="42" height="42" viewBox="0 0 24 24" id="quality-3" data-name="Line Color" class="icon line-color"><polyline id="secondary" points="11 8 12 7 12 13" style="fill: none; stroke: rgb(255, 209, 17); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"/><line id="secondary-2" data-name="secondary" x1="11" y1="13" x2="13" y2="13" style="fill: none; stroke: rgb(255, 209, 17); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"/><polyline id="primary" points="5.79 13.57 3 17.56 6.03 18.46 7.91 21 10.79 16.89" style="fill: none; stroke: rgb(0, 0, 0); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"/><polyline id="primary-2" data-name="primary" points="18.21 13.57 21 17.56 17.97 18.46 16.09 21 13.21 16.89" style="fill: none; stroke: rgb(0, 0, 0); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"/><circle id="primary-3" data-name="primary" cx="12" cy="10" r="7" style="fill: none; stroke: rgb(0, 0, 0); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"/></svg>
              </div>
          ...
          <div class="col-md-12 col-lg-3 border-end" data-aos="fade-up" data-aos-delay="200">
            <div class="d-flex">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" width="42" height="42" viewBox="0 0 24 24" id="check-lists" data-name="Line Color" class="icon line-color"><polyline id="secondary" points="7 4 4.33 7 3 5.5" style="fill: none; stroke: rgb(255, 209, 17); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"/><polyline id="secondary-2" data-name="secondary" points="3 11.5 4.33 13 7 10" style="fill: none; stroke: rgb(255, 209, 17); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"/><polyline id="secondary-3" data-name="secondary" points="3 17.5 4.33 19 7 16" style="fill: none; stroke: rgb(255, 209, 17); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"/><path id="primary" d="M11,6H21M11,12H21M11,18H21" style="fill: none; stroke: rgb(0, 0, 0); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"/></svg>
              </div>
              <div class="col-md-9 flex-fill">
          ...
          <div class="col-md-6 col-lg-3 border-end" data-aos="fade-up" data-aos-delay="400">
            <div class="d-flex">
              <div class="col-md-3 flex-fill pt-3 pt-3 pe-3 pe-md-0">
              <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" width="42" height="42" viewBox="0 0 24 24" id="brainstorming" data-name="Line Color" class="icon line-color"><path id="secondary" d="M12,5.5A2.5,2.5,0,0,1,17,5.05,2.48,2.48,0,0,1,19,7.5a2.37,2.37,0,0,1-.25,1.07A3,3,0,0,1,20,11a3,3,0,0,1-.78,2A3,3,0,0,1,17,18H17a2.94,2.94,0,0,1,.05.51,2.5,2.5,0,0,1-5,0Z" style="fill: none; stroke: rgb(255, 209, 17); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"/><path id="primary" d="M12,5.5a2.5,2.5,0,0,0-4.95-.45A2.48,2.48,0,0,0,5,7.5a2.37,2.37,0,0,0,.25,1.07A3,3,0,0,0,4,11a3,3,0,0,0,.78,2A3,3,0,0,0,7,18h0a2.94,2.94,0,0,0,0,.51,2.5,2.5,0,0,0,5,0Z" style="fill: none; stroke: rgb(0, 0, 0); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"/></svg>
              </div>
              <div class="col-md-9 flex-fill">
          ...
          <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="400">
            <div class="d-flex">
              <div class="col-md-3 flex-fill pt-3 pt-3 pe-3 pe-md-0">
              <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" width="42" height="42" viewBox="0 0 24 24" id="user-5" data-name="Line Color" class="icon line-color"><path id="secondary" d="M9,13a5,5,0,0,0-5,5H4v1s2,2,8,2,8-2,8-2V18h0a5,5,0,0,0-5-5Z" style="fill: none; stroke: rgb(255, 209, 17); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"/><circle id="primary" cx="12" cy="8" r="5" style="fill: none; stroke: rgb(0, 0, 0); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"/></svg>
              </div>
              <div class="col-md-9 flex-fill">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/vhosts/oikodomikigonia.gr/resources/views/home.blade.php ENDPATH**/ ?>